#!/usr/bin/env python3
"""Script to write updated React components with copy/export features."""
import os

BASE = os.path.dirname(os.path.abspath(__file__))
FE = os.path.join(BASE, "ai-delivery-manager-frontend", "src", "components")

STANDUP = r"""import { useState, useEffect } from "react"
...
WEEKLY = r"""import { useState, useEffect } from "react"
import api from "../services/api"
        ...
        <div>
          <div className="card">
            ...
            <div style={{marginTop:16, paddingTop:16, borderTop:"1px solid var(--gray-200)"}}>
              ...
              <ProgressBar pct={resp.progress_pct || 0} />
              {resp.stats && (
...
with open(os.path.join(FE, "Standup.jsx"), "w") as f:
    f.write(STANDUP)
print("Standup.jsx OK")

with open(os.path.join(FE, "WeeklyReport.jsx"), "w") as f:
    f.write(WEEKLY)
print("WeeklyReport.jsx OK")
